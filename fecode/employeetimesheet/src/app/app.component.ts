...
export class AppComponent implements OnInit {
  ...
  ngOnInit() {
    this.http.get<Employee[]>('api/v1/employee').subscribe((data) => {
      this.employees = data;
    });
  }
  ...
  logWork() {
    ...
    const params = new HttpParams()
      .set('id', this.selectedEmployee.employeeId.toString())
      .set('workDays', this.workDays.toString());
    this.http.post<any>('api/v1/employee/work', params).subscribe(
      (data) => {
        this.employees = data;
        this.vacations = null;
        this.workDays = null;
  ...
  takeVacation() {
    ...
    this.http.post<any>('api/v1/employee/vacation', params).subscribe(
      (data) => {
        this.employees = data;
        this.vacations = null;
        this.workDays = null;
